    ...
    return (
        <div className="space-y-6 animate-fade-in">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="font-display text-2xl font-semibold text-cafe-espresso">Categories</h1>
                    <p className="text-sm font-sans text-cafe-grounds/70 mt-1">Manage product categories and colors</p>
                </div>
