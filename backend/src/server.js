 ...
 *
 * Creates the HTTP server from the Express app, attaches the WebSocket server
 * to the same port, then starts listening.
 *
 * Run with: node src/server.js  (or via `npm run dev` which uses nodemon)
 */
